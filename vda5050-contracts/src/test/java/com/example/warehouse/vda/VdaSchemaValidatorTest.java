...
class VdaSchemaValidatorTest {
  ...
  @Test void acceptsProfileOrder() {
    var nodes = List.of(
        new Vda5050.Node("INBOUND", 0, true, new Vda5050.NodePosition(8, -5, "linz", new Vda5050.AllowedDeviationXY(.2, .2, 0)), List.of()),
        new Vda5050.Node("B1", 2, true, new Vda5050.NodePosition(-7, 2, "linz", new Vda5050.AllowedDeviationXY(.2, .2, 0)), List.of()));
