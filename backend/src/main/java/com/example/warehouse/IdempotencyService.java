...
class IdempotencyService {
  ...
  IdempotencyService(JdbcClient jdbc, ObjectMapper mapper, WarehouseStore store) {
    this.jdbc = jdbc;
    this.mapper = mapper;
    this.store = store;
  }
  ...
  @Transactional
  ApiModels.TransportOrderView createTransportOrder(String key, ApiModels.TransportOrderRequest request,
