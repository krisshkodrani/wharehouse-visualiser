...
public class JobExecutionService {
  ...
  public JobExecutionService(WarehouseStore store, DispatchService dispatch, EventPublisher events, WarehouseMetrics metrics) {
  ...
  public void agvIdle() { dispatch.dispatchNext(); }

  public void releaseNext(UUID taskId) { dispatch.releaseNext(taskId); }

  @Transactional
  public void cancelled(UUID taskId) {
